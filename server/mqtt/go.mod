module github.com/luobote55/kratos-transport-rpc/server/mqtt
...
require (
	...
	github.com/luobote55/kratos-transport-rpc/transport/mqtt v0.0.0-20230612152922-083cff90bb53
