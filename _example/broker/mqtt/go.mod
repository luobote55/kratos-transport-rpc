module github.com/luobote55/kratos-transport-rpc/example/broker/mqtt
...
require (
	...
	github.com/luobote55/kratos-transport-rpc/broker/mqtt v0.0.0-20230613065335-176757dd1f1c
